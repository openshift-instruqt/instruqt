...
imagestream.image.openshift.io/parksmap   default-route-openshift-image-registry.crc-dzk9v-master-0.crc.aa5od8iq5doy.instruqt.io/myproject/parksmap   1.3.0   35 seconds ago

NAME                                HOST/PORT                                                            PATH   SERVICES   PORT       TERMINATION   WILDCARD
route.route.openshift.io/parksmap   parksmap-myproject.crc-dzk9v-master-0.crc.aa5od8iq5doy.instruqt.io          parksmap   8080-tcp                 None            None
```
...
```
NAME       HOST/PORT                                                            PATH   SERVICES   PORT       TERMINATION   WILDCARD
parksmap   parksmap-myproject.crc-dzk9v-master-0.crc.aa5od8iq5doy.instruqt.io          parksmap   8080-tcp                 None
```
...
```
NAME       HOST/PORT                                                            PATH   SERVICES   PORT       TERMINATION   WILDCARD
parksmap   parksmap-myproject.crc-dzk9v-master-0.crc.ejsovmyiskmk.instruqt.io          parksmap   8080-tcp                 None
```
